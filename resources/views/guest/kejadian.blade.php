...
<body class="index-page">
  ...
  <main class="main">
   ...
   <section id="featured-services" class="featured-services section relative bg-cover bg-center bg-no-repeat"
    style="background-image: url('{{ asset('img/bg_kejadian.jpeg') }}');">
          ...
          <a href="#">
            <div class="disaster-article-card d-flex flex-column flex-md-row align-items-center p-4">
              ...
              <div class="disaster-article-content text-center text-md-start">
                <h3 class="fw-bold mb-2">{{ $dataKejadian->jenis_bencana }}</h3>
                <p class="text-muted mb-2">
                  <i class="fas fa-calendar-alt me-1 text-primary"></i> {{ $dataKejadian->tanggal }}
                  |
                  <i class="fas fa-map-marker-alt me-1 text-danger"></i> {{ $dataKejadian->lokasi_text }}
                </p>
                <p class="mb-0">{{ Str::limit($dataKejadian->dampak, 120, '...') }}</p>
              </div>
            </div>
          </a>
        </div>
        ...
        <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
          <a href="#" class="disaster-link">
            <div class="disaster-card text-center p-5">
              ...
              <p><i class="fas fa-calendar-alt me-1 text-primary"></i> {{ $item->alamat }}</p>
              <p><i class="fas fa-user-alt me-1 text-dark"></i> {{ $item->penanggung_jawab }}</p>
              <p><i class="fas fa-map-marker-alt me-1 text-danger"></i> {{ $item->kontak }}</p>
            </div>
          </a>
        </div>
      @endforeach
