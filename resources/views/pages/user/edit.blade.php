...
<body class="index-page">
  ...
  <main class="main">
    ...
    <!-- Section Form -->
    <section id="user-edit" class="section" data-aos="fade-up" data-aos-delay="100">
      <div class="container py-5">
        <div class="row justify-content-center">
          <div class="col-lg-6 col-md-8">
            <div class="card shadow-lg border-0 rounded-4">
              <div class="card-header bg-primary text-white text-center py-3">
                <h4 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Edit Data Pengguna</h4>
              </div>
              <div class="card-body p-4">
                ...
                <form action="{{ route('pages.users.update', $user->id) }}" method="POST">
                  ...
                  <div class="text-end">
                    <a href="{{ route('pages.users.index') }}" class="btn btn-secondary me-2">Batal</a>
